...
public class Constants {
	...
	//获取歌词的API路径
	public static final String NET_EASE_LYRIC_API_URL = "http://music.163.com/weapi/song/lyric";
	...
	//获取评论数大于该值的歌曲
	public static final int COMMENTS_LIMIT = 1000;
}